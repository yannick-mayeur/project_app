...
class UserTest < ActiveSupport::TestCase
  ...
  def setup
    @user = User.new(name: "Marty Maillet", email: "marty.maillet@etu.umontpellier.fr",
  ...
  test "email validation should accept valid addresses" do
    valid_addresses = %w[first.last@etu.umontpellier.fr first.last@umontpellier.fr]
  ...
  test "email validation should reject invalid addresses" do
    invalid_addresses = %w[user@example,com user_at_foo.org user.name@example.
                           foo@bar_baz.com foo@bar+baz.com first.last@exple.com]
  ...
  test "password should have a length of 6" do
